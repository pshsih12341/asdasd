...
import type { ListContainerProps, ListItemId, ListItemListContextProps, ListItemSize, ListItemViewCommonProps, ListItemViewContentType, UseListResult } from '../useList';
...
export type TreeListOnItemClickPayload<T> = {
    id: ListItemId;
    list: UseListResult<T>;
};
export type TreeListOnItemClick<T> = (payload: TreeListOnItemClickPayload<T>, e?: React.SyntheticEvent) => void;
