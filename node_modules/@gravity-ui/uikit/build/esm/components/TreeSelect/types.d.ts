...
import type { TreeListContainerProps, TreeListProps, TreeListRenderContainer, TreeListRenderItem } from '../TreeList/types';
...
export interface TreeSelectProps<T, P extends {} = {}> extends Omit<TreeListProps<T, P>, 'list' | 'renderContainer' | 'multiple'>, UseOpenProps, TreeSelectBehavioralProps<T> {
    /**
