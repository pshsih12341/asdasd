...
export type SliderInnerState = {
    max: number;
    min: number;
} & Pick<RcSliderProps, 'value' | 'defaultValue' | 'step' | 'range' | 'marks'> & Pick<SliderProps, 'tooltipDisplay' | 'tooltipFormat'>;
...
} & Pick<SliderProps, 'tooltipFormat'> & Pick<DOMProps, 'className'>;
export {};
