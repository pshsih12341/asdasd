 ...
 */
export function prepareSliderInnerState({ max = 100, min = 0, availableValues, defaultValue, marksCount, step, value, markFormat, marks, hasTooltip, tooltipDisplay, tooltipFormat, }) {
    const state = {
        value,
        defaultValue,
        range: false,
