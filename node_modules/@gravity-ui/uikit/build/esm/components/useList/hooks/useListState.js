...
export const useListState = ({ initialState, withExpandedState }) => {
    ...
    const [disabledById, setDisabled] = React.useState(() => { var _a; return (_a = initialState === null || initialState === void 0 ? void 0 : initialState.disabledById) !== null && _a !== void 0 ? _a : {}; });
    const [selectedById, setSelected] = React.useState(() => { var _a; return (_a = initialState === null || initialState === void 0 ? void 0 : initialState.selectedById) !== null && _a !== void 0 ? _a : {}; });
    const [expandedById, setExpanded] = React.useState(() => { var _a; return (_a = initialState === null || initialState === void 0 ? void 0 : initialState.expandedById) !== null && _a !== void 0 ? _a : {}; });
    const [activeItemId, setActiveItemId] = React.useState(() => initialState === null || initialState === void 0 ? void 0 : initialState.activeItemId);
