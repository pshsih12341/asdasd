...
export type ListItemListContextProps = ItemState & Partial<GroupParsedState> & {
    isLastItem: boolean;
};
...
export type InitialListParsedState = Pick<ListState, 'disabledById' | 'expandedById' | 'selectedById' | 'activeItemId'>;
...
type ListStructure<T> = ParsedState<T> & ParsedFlattenState & {
...
export type ListOnItemClick<El = Element, Ev = Event> = (payload: {
    id: ListItemId;
}, e?: React.SyntheticEvent<El, Ev>) => void;
export {};
